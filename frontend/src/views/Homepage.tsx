  ...
  return (
    <div className="flex flex-col min-h-screen min-w-screen bg-gray-800 items-center">
        ...
        <div className="felx m-30">
          <button className="w-50 h-20 rounded-3xl bg-blue-700 m-3 text-2xl text-white" onClick={() => newroom(setAppstate)}>New Room</button>
...
async function newroom(setAppstate : Function){
  try {
